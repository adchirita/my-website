  ...
  return (
    <main class="d-flex flex-row justify-content-center align-items-center text-light MainWrapper">
      <div class="DivContainer px-5">
        <h1 class="display-2 glow"><strong class="fadeIn" id="first">Hey, I'm Andrei.</strong></h1>
        <br />
        <p class="lead text-start fadeIn" id="second">I am a motivated full-stack web developer with proficiency in Javascript, React, NodeJS, and Express
        ...
        <br />
        <Link to="/about" class="btn btn-lg btn-light fw-bold border-white bg-white fadeIn" id="third">Learn more about me</Link>
      </div>
      <div class="DivContainer px-5 fadeIn"  id="fourth">
        <div>
          <img class="avatar-wobble box" src={require("../images/Selfie.png")} alt=""/>
        </div>
      </div>
    </main>
  )
